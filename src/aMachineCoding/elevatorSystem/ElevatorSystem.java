...
public class ElevatorSystem {
    public static void main(String[] args) throws InterruptedException {
        aMachineCoding.elevatorSystem.models.ElevatorSystem elevatorSystem = init();
        simulateElevatorSystem(elevatorSystem);
        // TODO: Change the code to get trigger at pushing buttons
    }

    private static aMachineCoding.elevatorSystem.models.ElevatorSystem init() {
        ...
        aMachineCoding.elevatorSystem.models.ElevatorSystem system = new aMachineCoding.elevatorSystem.models.ElevatorSystem(dispatcher);
        system.startElevators();
        registerListener(system);  // Register the listener here
        return system;
    }

    private static void registerListener(aMachineCoding.elevatorSystem.models.ElevatorSystem elevatorSystem) {
    ...
    private static void simulateElevatorSystem(aMachineCoding.elevatorSystem.models.ElevatorSystem elevatorSystem) throws InterruptedException {
    ...
    private static void printElevatorStatus(aMachineCoding.elevatorSystem.models.ElevatorSystem elevatorSystem) {
